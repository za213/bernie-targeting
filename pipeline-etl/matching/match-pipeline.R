...
# Build Input Table
cass_row_count <- civis::read_civis(x=sql(paste0('select count(*) from ',output_table_param$schema,'.',input_table_param$table,'_stage_0_input')), database = 'Bernie 2020') 
...
if (enable_cass == TRUE) {
        input_suffix = '_stage_5_coalesce'
        ...
        input_suffix = '_stage_0_input' # if skipping CASS set to initial table
}
...
match_job_civis <- civis::enhancements_post_civis_data_match(name = paste0('Civis Match Job 2: ',input_table_param$schema,'.',input_table_param$table),
                                                ...
                                                input_table = list(databaseName = 'Bernie 2020',
                                                                   schema = output_table_param$schema,
                                                                   table = paste0(input_table_param$table,input_suffix)),
                                                output_table = list(databaseName = 'Bernie 2020',
                                                                    schema = output_table_param$schema,
