...
from (
      select state_code, 
             ...
             sum(case when ccj.contactdate > pass_date then ccj_id_1 else 0 end) ccj_1_pass,
             sum(case when ccj.contactdate > pass_date then ccj_id_1_2_3_4_5 else 0 end) as ccj_all_pass,
             ...
             sum(case when contacttype = 'canvasses' and ccj.contactdate > pass_date then ccj_id_1 else 0 end) doors_ccj_1,
             sum(case when contacttype = 'canvasses' and ccj.contactdate > pass_date then ccj_id_1_2_3_4_5 else 0 end) as doors_ccj_all,
             ...
             sum(case when contacttype = 'getthru_dialer' and ccj.contactdate > pass_date then ccj_id_1 else 0 end) dialer_ccj_1,
             sum(case when contacttype = 'getthru_dialer' and ccj.contactdate > pass_date then ccj_id_1_2_3_4_5 else 0 end) as dialer_ccj_all,
             ...
             sum(case when contacttype = 'spoke' and ccj.contactdate > pass_date then ccj_id_1 else 0 end) cells_ccj_1,
             sum(case when contacttype = 'spoke' and ccj.contactdate > pass_date then ccj_id_1_2_3_4_5 else 0 end) as cells_ccj_all,
