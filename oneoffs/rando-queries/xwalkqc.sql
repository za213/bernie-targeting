...
inner join 
bernie_ifloreshuerta.master_xwalk_ak_20200223 dev
using(actionkit_id)
group by 1,2)
union all
(select 
...
inner join 
bernie_ifloreshuerta.master_xwalk_dnc_20200223 dev
using(person_id)
group by 1,2)
union all
(select 
...
inner join 
bernie_ifloreshuerta.master_xwalk_lal_20200223 dev
using(lalvoterid)
group by 1,2)
union all
(select 
...
inner join 
bernie_ifloreshuerta.master_xwalk_pdi_20200223 dev
using(pdiid)
group by 1,2)
union all
(select 
...
inner join 
bernie_ifloreshuerta.master_xwalk_st_myc_20200223 dev
using(st_myc_van_id)
group by 1,2)
union all
(select 
...
inner join 
bernie_ifloreshuerta.master_xwalk_st_myv_20200223 dev
using(st_myv_van_id)
group by 1,2)
